...
public class ParamsController {
    ...
    public String showParamsPage(@ModelAttribute HomeForm homeForm, Model model, WebRequest request) {
    ...
    public String getPapaers(@ModelAttribute HomeForm homeForm, @RequestParam String year, String branch, String semValue) {
        ...
        try {
            ...
            LOG.warn("ParamsController", exception);
        }
    ...
    public String showInternalMarksHome(@ModelAttribute HomeForm homeForm,MarksMasterForm marksMasterForm,  WebRequest request) {
        LOG.debug(homeForm.getYear() + " " + homeForm.getBranch() + " " + homeForm.getSemister() + " " + homeForm.getSemister()+homeForm.getHasAssMarks());
        ...
        master.setHasAssMarks(homeForm.getHasAssMarks());
